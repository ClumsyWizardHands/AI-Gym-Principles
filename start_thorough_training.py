"""Start a thorough training session for the Adaptive Bridge Builder agent."""
...
AGENT_ID = "6565c56e-9297-41d5-83ff-9c0ccb7fab42"
...
def start_training():
    ...
    print("🚀 Starting Thorough Training Session")
    print("=" * 50)
...
def main():
    ...
    print("🎯 AI Principles Gym - Thorough Training Session")
    ...
    try:
        agent_response = requests.get("http://localhost:8080/", timeout=2)
